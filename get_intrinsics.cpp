...
#define N_SAMPLES 65
#define N_HCORNERS 7 // internal corners
#define N_VCORNERS 7
#define SIDE_SIZE 20 // in mm
#define SAMPLES_DIR "chessboard_UI-3271LE-C-HQ-VU/*.jpg"   
...
int main() {
    ...
    while(i < N_SAMPLES) {
      ...
      if(found) {
          // Refine the corners
          cornerSubPix(gray_image, corners, Size(11, 11), Size(-1, -1), TermCriteria(CV_TERMCRIT_EPS | CV_TERMCRIT_ITER, SIDE_SIZE, 0.1)); 
    ...
    if(successes > 0) {
      ...
      printf("Found chessboards, calibrating with %d successes\n", successes);
